...
require "google/cloud/security/private_ca/version"
...
::Google::Cloud.configure.add_config! :security_private_ca do |config|
  config.add_field! :endpoint,      "privateca.googleapis.com", match: ::String
      ...
      module PrivateCA
        ...
        def self.certificate_authority_service version: :v1, &block
          ...
          package_name = Google::Cloud::Security::PrivateCA
                         ...
                         .first
          package_module = Google::Cloud::Security::PrivateCA.const_get package_name
          package_module.const_get(:CertificateAuthorityService).const_get(:Client).new(&block)
        end
        ...
        #
        # By default, this returns an instance of
        # [Google::Cloud::Security::PrivateCA::V1::IAMPolicy::Client](https://googleapis.dev/ruby/google-cloud-security-private_ca-v1/latest/Google/Cloud/Security/PrivateCA/V1/IAMPolicy/Client.html)
        # for version V1 of the API.
        # However, you can specify specify a different API version by passing it in the
        ...
        #
        # By default, this returns an instance of
        # [Google::Cloud::Security::PrivateCA::V1::Locations::Client](https://googleapis.dev/ruby/google-cloud-security-private_ca-v1/latest/Google/Cloud/Security/PrivateCA/V1/Locations/Client.html)
        # for version V1 of the API.
        # However, you can specify specify a different API version by passing it in the
        ...
        #
        def self.configure
          yield ::Google::Cloud.configure.security_private_ca if block_given?

          ::Google::Cloud.configure.security_private_ca
        end
      end
    end
  end
...
helper_path = ::File.join __dir__, "private_ca", "helpers.rb"
require "google/cloud/security/private_ca/helpers" if ::File.file? helper_path
